	  ...
	  error_function(err_function)
{
	...
	if (!nodes || !arcs) { //if (error_function) (*error_function)("Not enough memory!"); 
	exit(1); }
	...
	void Graph<captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
	...
	if (!nodes) { //if (error_function) (*error_function)("Not enough memory!"); 
	exit(1); }
	...
	void Graph<captype,tcaptype,flowtype>::reallocate_arcs()
{
	...
	if (!arcs) { //if (error_function) (*error_function)("Not enough memory!"); 
		exit(1); }
